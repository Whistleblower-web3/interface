import{k as t,n as e,l as i,m as o,x as r,y as n,D as a,O as s,G as l,E as c,R as u,P as d,q as h,Q as p,U as g,I as w,W as f,C as b,u as v,T as m,B as y,M as x,V as $,b as C,L as k,o as R}from"./core-BHGto_Gd.js";import{n as I,c as E,o as T,r as P,U as O,e as j,f as S,a as L}from"./index-DdmF1NgQ.js";import{m as z}from"./index-BB8uQJur.js";import"./events-CC3zeWHn.js";import"./index.es-BztAd4mf.js";const A=t`
  :host {
    position: relative;
...
`;let $i=class extends Ut{constructor(){var t;super(),this.forceUpdate=()=>{this.requestUpdate()},window.addEventListener("resize",this.forceUpdate),c.sendEvent({type:"track",event:"SELECT_WALLET",properties:{name:(null==(t=this.wallet)?void 0:t.name)??"WalletConnect",platform:"qrcode"}})}disconnectedCallback(){var t;super.disconnectedCallback(),null==(t=this.unsubscribe)||t.forEach(t=>t()),window.removeEventListener("resize",this.forceUpdate)}render(){return this.onRenderProxy(),r`
    ...
    ></wui-flex>`}};Ti([P()],Pi.prototype,"isMobile",void 0),Pi=Ti([E("w3m-connecting-wc-basic-view")],Pi);const Oi=()=>new ji;class ji{}const Si=/* @__PURE__ */new WeakMap,Li=j(class extends S{render(t){return k}update(t,[e]){var i;const o=e!==this.G;return o&&void 0!==this.G&&this.rt(void 0),(o||this.lt!==this.ct)&&(this.G=e,this.ht=null==(i=t.options)?void 0:i.host,this.rt(this.ct=t.element)),k}rt(t){if(this.isConnected||(t=void 0),"function"==typeof this.G){const e=this.ht??globalThis;let i=Si.get(e);void 0===i&&(i=/* @__PURE__ */new WeakMap,Si.set(e,i)),void 0!==i.get(this.G)&&this.G.call(this.ht,void 0),i.set(this.G,t),void 0!==t&&this.G.call(this.ht,t)}else this.G.value=t}get lt(){var t,e;return"function"==typeof this.G?null==(t=Si.get(this.ht??globalThis))?void 0:t.get(this.G):null==(e=this.G)?void 0:e.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),zi=t`
  :host {
    display: flex;
    align-items: center;
    justify-content: center;
