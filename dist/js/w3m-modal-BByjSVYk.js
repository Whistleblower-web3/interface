import{i as e,p as t,s as i,j as o,M as a,S as r,R as s,k as n,l as c,m as l,x as w,A as d,n as u,o as p,C as m,q as h,u as v,v as g,E as f,O as b,y,z as x,B as k,D as C,T as S,F as R,G as N,I as O}from"./core-BHGto_Gd.js";import{c as T,n as A,r as W,o as $,U as E}from"./index-DdmF1NgQ.js";import"./index-BB8uQJur.js";import"./events-CC3zeWHn.js";import"./index.es-BztAd4mf.js";const I=t({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),P=e({state:I,subscribe:e=>o(I,()=>e(I)),subscribeKey:(e,t)=>i(I,e,t),showTooltip({message:e,triggerRect:t,variant:i}){I.open=!0,I.message=e,I.triggerRect=t,I.variant=i},hide(){I.open=!1,I.message="",I.triggerRect={width:0,height:0,top:0,left:0}}}),j={isUnsupportedChainView:()=>"UnsupportedChain"===s.state.view||"SwitchNetwork"===s.state.view&&s.state.history.includes("UnsupportedChain"),async safeClose(){if(this.isUnsupportedChainView())return void a.shake();await r.isSIWXCloseDisabled()?a.shake():a.close()}},D=n`
  :host {
    display: block;
